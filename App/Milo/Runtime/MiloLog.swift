...
enum MiloLog {
    ...
    enum Code: String, Sendable {
        ...
        case uninstallHelperRemovalFailed = "uninstall.helper-removal-failed"
        case uninstallLegacyHelperDetected = "uninstall.legacy-helper-detected"
        case uninstallBundleMoveFailed = "uninstall.bundle-move-failed"
